  ...
  export default {
    ...
    methods:{
      ...
      submit:function(){
        ...
        params.append('marriageFlag', _this.form.marriageFlag);
        params.append('tall', _this.form.tall);
        params.append('weight', _this.form.weight);
        params.append('detail', _this.form.detail);
        params.append('sport', _this.form.sport);
        params.append('smoke', _this.form.smoke);
        params.append('child', _this.form.child);
        params.append('drink', _this.form.drink);
        params.append('education', _this.form.education);
        params.append('money', _this.form.money);
        params.append('job', _this.form.job);
        params.append('address', _this.form.address);
