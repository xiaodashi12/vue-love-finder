    ...
    <div class="admin-content">
      <div class="" style="width: 80%;float:left;">
        ...
        <div class="am-btn-group am-btn-group-xs" style="float:right;">
          <button style="display: none;" class="am-btn am-btn-default" type="button" @click="getConnection()"><span class="am-icon-plug"></span> 连接</button>
          <button style="display: none;" class="am-btn am-btn-default" type="button" @click="closeConnection()"><span class="am-icon-remove"></span> 断开</button>
